...
//----------------------------------------------------------------------------------------------------------
//    onavsim Overlay Factory Implementation
//----------------------------------------------------------------------------------------------------------

onavsimOverlayFactory::onavsimOverlayFactory( onavsimUIDialog &dlg )
	: m_dlg(dlg)
{
...
*/
wxPoint onavsimOverlayFactory::ScaleCurrentArrow(int index, wxPoint myPoint, int scale)
{
...
void onavsimOverlayFactory::Reset()
{

}

bool onavsimOverlayFactory::RenderGLonavsimOverlay( wxGLContext *pcontext, PlugIn_ViewPort *vp )
{
...
bool onavsimOverlayFactory::RenderonavsimOverlay( wxDC &dc, PlugIn_ViewPort *vp )
{
...
bool onavsimOverlayFactory::DoRenderonavsimOverlay( PlugIn_ViewPort *vp )
{
...
void onavsimOverlayFactory::DrawMessageWindow( wxString msg, int x, int y , wxFont *mfont)
{
    if(msg.empty())
        return;
...
wxColour onavsimOverlayFactory::GetSpeedColour(double my_speed){
...
bool onavsimOverlayFactory::drawCurrentArrow(int x, int y, double rot_angle, double scale, double rate )
{   	
...
wxImage &onavsimOverlayFactory::DrawGLText( double value, int precision ){
...
wxImage &onavsimOverlayFactory::DrawGLTextDir( double value, int precision ){
...
wxImage &onavsimOverlayFactory::DrawGLTextString( wxString myText ){
...
void onavsimOverlayFactory::DrawGLLine( double x1, double y1, double x2, double y2, double width, wxColour myColour )
{
    {
...
void onavsimOverlayFactory::DrawGLLabels(onavsimOverlayFactory *pof, wxDC *dc,
                                PlugIn_ViewPort *vp,
...
wxImage &onavsimOverlayFactory::DrawGLPolygon(){
...
void onavsimOverlayFactory::drawGLPolygons(onavsimOverlayFactory *pof, wxDC *dc,
                                PlugIn_ViewPort *vp,
                                wxImage &imageLabel, double myLat, double myLon, int offset )
{
